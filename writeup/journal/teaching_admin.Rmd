...
In general, the teacher does not know students' priors and must represent them approximately as $\hat{S} = {\hat{s_1} ... \hat{s_m}}$. Teachers use these estimates to compute their objective function, to maximize their estimate of students' *information gain* ($IG_T$) given a particular set of examples $E$:
