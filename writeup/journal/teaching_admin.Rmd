...
In the following simulations, we quantify the advantages due to different decisions, and give some generalizations that hold across parameter regimes. 
