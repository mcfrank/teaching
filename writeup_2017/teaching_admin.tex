...
\begin{CodeChunk}
\begin{figure}[tb]
\includegraphics{figs/unnamed-chunk-2-1} \caption[Student information gain when sorted into class- rooms based on prior beliefs over unsorted baseline]{Student information gain when sorted into class- rooms based on prior beliefs over unsorted baseline}\label{fig:unnamed-chunk-2}
\end{figure}
\end{CodeChunk}
